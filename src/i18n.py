...
GLOBAL_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "status_cost_title": "Session cost",
        "status_cost_calls": "{calls} calls \u00b7 {tokens} tokens",
        "status_cost_session": "~${cost} this session",
        "status_activity_title": "Activity",
        "status_activity_ready": "Ready",
        "status_activity_busy": "Working...",
        "status_activity_error": "Error",
    ...
    "cs": {
        ...
        "status_cost_title": "Náklady relace",
        "status_cost_calls": "{calls} volání \u00b7 {tokens} tokenů",
        "status_cost_session": "~${cost} v této relaci",
        "status_activity_title": "Aktivita",
        "status_activity_ready": "Připraveno",
        "status_activity_busy": "Pracuji...",
        "status_activity_error": "Chyba",
