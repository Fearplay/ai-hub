...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "key_github_hint": "Read-only token. Optional - lets AI CV fetch your public repos with a higher rate limit.",
        "key_save_btn": "Save",
    ...
    "cs": {
        ...
        "key_github_label": "GitHub personal access token",
        "key_github_hint": "Read-only token. Volitelné - umožní AI Životopis stáhnout vaše veřejné repozitáře s vyšším limitem.",
        "key_save_btn": "Uložit",
